...
from artiq_scan_framework.beta.models.freq_model import BetaFreqModel
...
class TestFreqScan(Scan1D, FreqScan, EnvExperiment):
    ...
    def prepare(self):
        self.model = BetaFreqModel(self, namespace='beta', fit_function=Sinc, main_fit='frequency')
